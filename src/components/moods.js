...
const style = {
  ...
  return (
    <div className="widget-moods container">
      ...
      <div>
        <button value={mood} onClick={happyclick}>Make Happy</button>
        <button value={mood} onClick={sadclick}>Make Sad</button>
        <button value={mood} onClick={initialclick}>Reset</button>
      </div>
    </div>
  );
}
